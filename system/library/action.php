...
class Action {
     ...
     * @return	mixed
     */
    public function execute(\WebSiteToYou\System\Library\Registry $registry, array &$args = []): mixed {
        ...
        $class = 'WebSiteToYou\\' . $registry->get('config')->get('application') . '\\' . $this->class;
